	...
	<div id="app">
		<div style="background-color: rgb(233, 233, 233)" class="container-fluid ">
			<div class="row h-100 d-md-flex">
				...
				{{-- ------------------------- navbar desktop -------------------- --}}
				<nav
					class="navbar-desktop position-fixed text-center d-none col-lg-2 d-lg-flex flex-column vh-100 flex-shrink-0 p-3 text-white navbar-dark sidebar h-100">
					{{-- logo --}}
				...
				{{-- ------------------------- main app -------------------- --}}
				<main class="mt-5 mt-md-0 ms-sm-auto col-lg-10 px-md-4 overflow-auto  p-3" style="height:100vh;">
					@yield('content')
				</main>
			</div>
		</div>
