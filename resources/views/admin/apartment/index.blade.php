		...
		<div class="rounded overflow-hidden shadow">
			<table class="d-none d-md-block table table-responsive shadow-lg w-100 m-auto ">
				<thead class="text-center">
					<tr class="d-none d-md-table-row" style="background: linear-gradient(130deg, #ffd489a4, #8cd7f298) !important;">
						<div>
							<th scope="col">
						...
						<tr class="text-center align-middle" style="height: 1rem">
							...
							<td class="d-none d-md-table-cell col-3">
								<div class="d-flex flex-column justify-content-center align-items-center">
									...
									@endif
									<button class="btn btn-outline-primary rounded-4" type="button" data-bs-toggle="offcanvas"
										data-bs-target="#offcanvasRight-{{ $apartment->id }}" aria-controls="offcanvasRight">
										<i class="fa-solid fa-arrow-up-right-dots"></i>
										Sponsorizza ora
									</button>
								</div>
								<div class="offcanvas w-100 offcanvas-end" style="tabindex="-1" id="offcanvasRight-{{ $apartment->id }}"
							...
							<td class="d-none d-md-table-cell col-12">
								<div class="d-flex pippo gap-1">
									...
									<button type="button" class="col-4 btn p-0 btn-danger text-dark my-1 elimina rounded-3" data-bs-toggle="modal"
						...
						<div class="col-md-8">
							<div class="card-body">
								...
								<div class="d-flex flex-column">
									@if ($apartment->lastSponsorship)
										<p class="text-center text-primary">La sponsorizzazione termina
											...
											{{ $apartment->lastSponsorship->pivot->ending_date }}</p>
									@endif
									<button class="btn btn-outline-primary rounded-4 mb-3" type="button" data-bs-toggle="offcanvas"
								...
								<div class="offcanvas w-100 offcanvas-end" style="" tabindex="-1"
									id="offcanvasSponsor-{{ $apartment->id }}" aria-labelledby="offcanvasSponsorLabel-{{ $apartment->id }}">
								...
								<div class="mobile d-flex justify-content-between mt-3">
									<a href="{{ route('apartments.show', $apartment->id) }}" class="visualizza col-3-5 btn btn-light"><i
											class="fa-solid fa-magnifying-glass"></i>
										Visualizza</a>
									<a href="{{ route('apartments.edit', $apartment->id) }}"
										class=" modifica col-3-5 btn btn-warning text-dark"><i class="fa-solid fa-pen"></i>
										Modifica</a>
									<button type="button" class="elimina text-dark col-3-5 btn btn-danger" data-bs-toggle="modal"
										data-bs-target="#modal-{{ $apartment->id }}">
