...
@section('content')
    <div class="container-xl px-0 w-md-100">
        <div class="d-flex justify-content-between align-items-center container-xl mb-4">
            ...
            <div class="d-none d-md-block add-apartment shadow">
                <div class="background-white"><a class="text-decoration-none" href="{{ route('apartments.create') }}">Aggiungi
                        appartamento</a>
                </div>
            </div>
            <div class="d-md-none add-apartment-mobile shadow">
                        ...
                        <tr class="text-center align-middle" style="height: 1rem">
                            ...
                            <td class="d-none d-md-table-cell col-12">
                                <div class="d-flex pippo gap-1">
                                    ...
                                    <button type="button"
                                        class="col-4 btn p-0 btn-danger text-dark my-1 elimina rounded-3"
