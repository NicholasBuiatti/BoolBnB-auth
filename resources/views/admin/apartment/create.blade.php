...
@section('content')
    <div class="margin-top" style="max-width: 1000px; margin: 0 auto;">
        ...
        <div class="rounded shadow background" style="max-width: 1000px">
                ...
                <form id="apartmentForm" method="POST" action="{{ route('apartments.store') }}" class="w-100 p-3 row"
                    ...
                    <div class="mb-3 col-12 col-sm-8">
                        ...
                        @error('image')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                        <p id="fileSizeError" style="color:red; display:none;">Il file supera le dimensioni massime di 5
                            mb.
                        </p>
                    ...
                    <button type="submit" class="btn btn-primary col-5 col-md-3" id='btnSend'>Salva Appartamento
                    </button>
                </form>
            </div>
        </div>
